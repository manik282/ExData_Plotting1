...
par(mfrow = c(2,2))
plot(x = household_subset$Datetime, y = household_subset$Global_active_powerkwh,type = "l", ylab = "Global active power (kilowatts)",xlab = "")
plot(x = household_subset$Datetime, y = household_subset$Voltage,type = "l", ylab = "Voltage",xlab = "datetime")
...
plot(x = household_subset$Datetime, y = household_subset$Global_reactive_power,type = "l", ylab = "Global_reactive_power",xlab = "datetime")
